        ...
        <div className="container mt-5">
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    <button className="carousel-btn btn-left" onClick={() => scrollCharactersRef.current.scrollBy({ left: -300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
                        <i className="bi bi-chevron-left"></i>
                    </button>
                    <div className="carousel-scroll" ref={scrollCharactersRef}> // ✅ Referencia a la lista de personajes
                    ...
                    <button className="carousel-btn btn-right" onClick={() => scrollCharactersRef.current.scrollBy({ left: 300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
            ...
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    <button className="carousel-btn btn-left" onClick={() => scrollPlanetsRef.current.scrollBy({ left: -300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
                        <i className="bi bi-chevron-left"></i>
                    </button>
                    <div className="carousel-scroll" ref={scrollPlanetsRef}> // ✅ Referencia a la lista de planetas
                    ...
                    <button className="carousel-btn btn-right" onClick={() => scrollPlanetsRef.current.scrollBy({ left: 300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
                        <i className="bi bi-chevron-right"></i>
                    </button>
                </div>
            </div>
            ...
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    <button className="carousel-btn btn-left" onClick={() => scrollStarshipsRef.current.scrollBy({ left: -300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
                        <i className="bi bi-chevron-left"></i>
                    </button>
                    <div className="carousel-scroll" ref={scrollStarshipsRef}> // ✅ Referencia a la lista de naves
                    ...
                    <button className="carousel-btn btn-right" onClick={() => scrollStarshipsRef.current.scrollBy({ left: 300, behavior: 'smooth' })}> // ✅ Buen uso del scroll
                        <i className="bi bi-chevron-right"></i>
                    </button>
                </div>
            </div>
