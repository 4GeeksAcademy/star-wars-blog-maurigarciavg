...
export const Home = () => {
    ...
    // 📝 Función para obtener naves estelares
        ...
        <div className="container mt-5">
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    ...
                    <div className="carousel-scroll" ref={scrollCharactersRef}> // ✅ Uso correcto de ref para el scroll
            ...
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    ...
                    <div className="carousel-scroll" ref={scrollPlanetsRef}> // ✅ Uso correcto de ref para el scroll
            ...
            <div className="section-wrapper text-center">
                ...
                <div className="carousel-container">
                    ...
                    <div className="carousel-scroll" ref={scrollStarshipsRef}> // ✅ Uso correcto de ref para el scroll
